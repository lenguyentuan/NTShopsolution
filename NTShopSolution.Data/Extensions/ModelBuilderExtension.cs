    ...
    public static class ModelBuilderExtension
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            ...
            (
                ...
                new CategoryTranslation() { Id = 3, CategoryId = 2, LanguageId = "vi-VN", Name = "Ao Nu", SeoAlias = "abc", SeoDescription = "abc", SeoTitle = "abc" },
                new CategoryTranslation() { Id = 4, CategoryId = 2, LanguageId = "en-US", Name = "women T-shirt", SeoAlias = "abc", SeoDescription = "abc", SeoTitle = "abc" }
            );
            ...
            (
                new ProductTranslation() { Id = 1, ProductId = 1, LanguageId = "vi-VN", Name = "Ao Nam", SeoAlias = "abc", SeoDescription = "abc", SeoTitle = "abc", Details = "abc" },
                new ProductTranslation() { Id = 2, ProductId = 1, LanguageId = "en-US", Name = "men T-shirt", SeoAlias = "abc", SeoDescription = "abc", SeoTitle = "abc", Details = "abc" }
            );
